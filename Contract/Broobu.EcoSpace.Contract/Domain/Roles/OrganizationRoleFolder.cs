...
namespace Broobu.EcoSpace.Contract.Domain.Roles
{
    ...
    /// </summary>
    [DataContract]
    public class OrganizationRoleFolder : RoleFolder
    {
        public const string ID = "ORGANIZATION_ROLE_FOLDER";
        /// <summary>
        /// Initializes a new instance of the <see cref="OrganizationRoleFolder"/> class.
        /// </summary>
        public OrganizationRoleFolder()
        {
            Id = ID;
        ...
        {
            return DataErrorInfoValidator<OrganizationRoleFolder>.Validate(this, columnName);
        }
        ...
        {
            return DataErrorInfoValidator<OrganizationRoleFolder>.Validate(this);
        }
