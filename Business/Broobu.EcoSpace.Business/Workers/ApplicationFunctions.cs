...
namespace Broobu.EcoSpace.Business.Workers
{
    ...
    class ApplicationFunctions :  IApplicationFunctions
    {
        ...
        public void RegisterRequiredDomainObjects()
        {
            try
            {
                ApplicationFunction rootItem = EcoSpaceProvider.ApplicationFunctions.RootFolder;
                Provider<ApplicationFunction>.Save(rootItem);
                ApplicationFunction unregisteredItem = EcoSpaceProvider.ApplicationFunctions.UnRegisteredFolder;
                Provider<ApplicationFunction>.Save(unregisteredItem);
                ApplicationFunction communityItem = EcoSpaceProvider.ApplicationFunctions.CommunityFolder;
