    ...
    public class TextBoxMask
    {
        ...
        public static readonly DependencyProperty MaxLengthProperty =
            DependencyProperty.RegisterAttached(
                ...
                typeof (int),
                typeof (TextBoxMask),
                new FrameworkPropertyMetadata(int.MaxValue, MaxLengthChangedCallback));
        ...
        private static void ValidateTextBox(TextBox _this)
        {
            ...
            {
                _this.Text = ValidateValue(GetMask(_this), _this.Text, GetMaxLength(_this), GetMinimumValue(_this),
        ...
        private static void TextBoxPastingEventHandler(object sender, DataObjectPastingEventArgs e)
        {
            ...
            clipboard = ValidateValue(GetMask(_this), clipboard, GetMaxLength(_this), GetMinimumValue(_this),
                GetMaximumValue(_this));
        ...
        private static void TextBox_PreviewTextInput(object sender, TextCompositionEventArgs e)
        {
            ...
            if (isValid)
            {
                ...
                if (mask == MaskType.Integer || mask == MaskType.Decimal)
                {
        ...
        private static string ValidateValue(MaskType mask, string value, int maxlength, double min, double max)
        {
        ...
        private static bool IsSymbolValid(MaskType mask, string str)
        {
            ...
            if (mask.Equals(MaskType.AlphaNumeric))
            {
                foreach (char ch in str)
                {
