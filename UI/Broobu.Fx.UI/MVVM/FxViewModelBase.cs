...
namespace Broobu.Fx.UI.MVVM
{
    ...
    /// </summary>
    public abstract class FxViewModelBase : DevExpress.Mvvm.ViewModelBase, IDataErrorInfo, IViewModel
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="FxViewModelBase" /> class.
        /// </summary>
        protected FxViewModelBase()
        {
        ...
        public string this[string columnName]
        {
            get
            {
                ...
                if (!_allValidators.TryGetValue(columnName, out validators)) return string.Empty;
        ...
        public string Error
        {
            get
            {
                ...
                foreach (var validator in _allValidators.Values)
                {
                    object value = validator.Key.DynamicInvoke(this);
                    messages.AddRange(validator.Value.Where(v => !v.IsValid(value)).Select(v => v.ErrorMessage ?? ""));
                }
        ...
        protected virtual void StartAuthenticatedSession()
        {
        }
        ...
        public virtual void TerminateAuthenticatedSession(Action onSessionTerminated = null)
        {
        }
